...
class OCLMetrics:
    ...
    """The anytime accuracy (see :prop:`anytime_accuracy`) at each task boundary."""
    average_anytime_accuracy_series: np.ndarray
    """The average anytime accuracy (see :prop:`average_anytime_accuracy`) at each task boundary."""
    online_accuracy_series: np.ndarray
    """The online accuracy (see :prop:`online_accuracy`) at each task boundary."""
    ...
    def accuracy(self) -> float:
        """Alias for :prop:`anytime_accuracy`."""
